...
public class ClimbingStairsWithRecursion {

    // public static int countWays(int n) { ----with recurssion
    // if (n == 0) {
    // return 1;
    // }
    // if (n < 0) {
    ...
    public static int countWaysTabs(int n) {
        int dp[] = new int[n + 1];
        dp[0] = 1;
        for (int i = 1; i <= n; i++) {
            if (i == 1) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(countWaysTabs(n));
    }
}
